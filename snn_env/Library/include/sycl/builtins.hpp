...
extern "C" {
extern __DPCPP_SYCL_EXTERNAL int feenableexcept(int excepts) noexcept(true);
extern __DPCPP_SYCL_EXTERNAL int fedisableexcept(int excepts) noexcept(true);
extern __DPCPP_SYCL_EXTERNAL int feclearexcept(int excepts) noexcept(true);
extern __DPCPP_SYCL_EXTERNAL int fetestexcept(int excepts) noexcept(true);
