...
// Commented typedefs below are previously defined in mmintrin.h or xmmintrin.h
// Those defined in mmintrin.h were transitively included via xmmintrin.h, so
// include that explicitly in case there are further changes.
